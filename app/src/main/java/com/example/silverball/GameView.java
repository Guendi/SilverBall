...
public class GameView extends View implements IGameView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //draw points bottom left
        canvas.drawText(Integer.toString(points)+"Punkte",50*scale,canvas.getHeight()-30*scale, paintText);
        // possible points top left
        canvas.drawText(Integer.toString(totalPoints)+"Total",10*scale,40*scale, paintText);
        ...
        //fps top right
        canvas.drawText(Integer.toString(getFps())+" FPS",canvas.getWidth()-70*scale, 40*scale,paintText);
        frames++;
    }
